    ...
    <SafeAreaView style={styles.root} edges={['top', 'bottom']}>
      <View style={{ flex: 1, padding: theme.space['2xl'], justifyContent: 'center' }}>
        <Card>
          ...
          <Body muted style={{ marginTop: theme.space.md }}>
            Tapping the button below will open your official Tesla app to approve the connection. Note: This app requires a vehicle with MCU2 or newer that supports Fleet Telemetry (including older models that have been upgraded to MCU2).
          </Body>
        </Card>
